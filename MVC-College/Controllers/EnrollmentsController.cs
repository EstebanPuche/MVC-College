...
namespace MVC_College.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public EnrollmentsController(MVC_CollegeContexto context)
        {
            _context = context;
        }
        ...
        {
            var mVC_CollegeContexto = _context.Enrollments.Include(e => e.Course).Include(e => e.Student);
            return View(await mVC_CollegeContexto.ToListAsync());
        }
